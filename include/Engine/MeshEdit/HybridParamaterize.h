...
namespace Ubpa {
	...
	// mesh boundary == 1
	class HybridParamaterize : public HeapObj {
	public:
		HybridParamaterize(Ptr<TriMesh> triMesh);
	public:
		static const Ptr<HybridParamaterize> New(Ptr<TriMesh> triMesh) {
			return Ubpa::New<HybridParamaterize>(triMesh);
		}
	public:
		void Clear();
		...
		void SetLambda(double lambdaPara) {
			lambda = lambdaPara;
		}
